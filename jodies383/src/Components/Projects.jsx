...
import myFavMovies from '/myfavouritemovies.png';
import stampedeImg from '/stampede.jpeg';
import wordsWidgetImg from '/wordswidget.png';
...
export default function Projects() {
    ...
    return (
        <div className="App">
            ...
            <a href="https://github.com/jodies383/my-favourite-movies"><div className="card1">
                <img src={myFavMovies} alt="My Favourite Movies" width="448rem" />
            ...
            <a href="https://github.com/Dramatic-Wire/gwi-app">    <div className="card1">
                <img src={stampedeImg} alt="Stampede" width="200rem" />
                    <div className="container">
                        <h2><b>Stampede</b></h2>
                        <p>
            ...
            <a href="https://github.com/jodies383/WordsWidget">  <div className="card1">
                <img src={wordsWidgetImg} alt="Words Widget" width="448rem" />
                    <div className="container">
